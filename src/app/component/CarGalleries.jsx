        ...
        <div className='relative w-full text-center pt-8'>
          ...
          <div className='absolute inset-0 flex items-center justify-center'>
            ...
            <div className='absolute bottom-0 mb-4'>
              <p className='text-black bg-white bg-opacity-50 px-4 py-2 uppercase text-sm'>
          ...
          <div className='relative w-full items-center bg-white flex flex-col sm:flex-row sm:justify-center sm:gap-4'>
            <div className='absolute top-0 text-center bg-center py-8 text-black' >
                <h2>Best Choice</h2>
                <p>The new Electric Vehicle and Fuel Electric Vehicle</p>
            </div>
      <div className='relative h-[400px] overflow-hidden flex items-center'>
        <div className='bg-[#F0F4EF] max-w-[400px] min-h-[300px] rounded-lg flex items-center justify-center p-4'>
          <Image
          ...
          />
          <div className='absolute bottom-0 text-black text-center'>
